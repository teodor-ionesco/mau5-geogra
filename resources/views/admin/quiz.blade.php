...
@section('body')
	...
	<div class="container">
		<form method="POST">
			...
			<a target="_BLANK" class="btn waves-effect waves-light blue" href="{{ str_replace('/admin', '', url() -> current()) }}">View Quiz</a>
			<a class="btn waves-effect waves-light blue" href="{{ url() -> current() . '/../'}}">Back to theory</a>
			<hr>
